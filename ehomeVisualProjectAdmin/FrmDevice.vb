...
Imports System.IO
Imports eHomeApi.eHomeApi.Device
...
Public Class FrmDevice
    ...
    Private Sub FrmDevice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i As Integer = 0 To FRMMere.Obj.Adapters.Count - 1
            LDriver.Items.Add(FRMMere.Obj.Adapters.Item(i)) '.PluginName)
        Next
        LDriver.DisplayMember = "PluginName"
